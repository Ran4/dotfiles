...
if version >= 700
    hi CursorLine ctermbg=254 cterm=none            guibg=#32322f
...
hi String   ctermfg=19 guifg=#D81745
hi Char     ctermfg=161 guifg=#D81745
hi Function ctermfg=88 guifg=#990000 gui=bold cterm=bold
hi Statement    ctermfg=0 guifg=#000000 gui=bold cterm=bold
hi Type     ctermfg=31 guifg=#445588 gui=bold   cterm=bold
...
hi Keyword      ctermfg=89 guifg=#000000 gui=bold    cterm=bold
hi Operator      ctermfg=89 guifg=#000000 gui=bold    cterm=bold
hi TypeDef      ctermfg=89 guifg=#000000 gui=bold    cterm=bold
...
"Added by Ran, for Elm

hi def link Braces TypeDef
hi def link CurlyBraces Type
